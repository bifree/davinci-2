    ...
    <div class="middle-blue">
        <div class="middle-inner-blue">
            <div class="blue-inner">
                ...
                <h4>世界と思考と性質</h4>
                <h5>- 経済の原理原則を学ぶ -</h5>
                <p>投資とは、利益を得ることを目的として、将来的な成長が見込める事業や不動産、証券などへお金を投じることを指します。<br">DaVinci「ファイナンス」コースでは、株式や為替市場、原油やゴールド等の先物市場に触れることで、投資の本質を様々な角度から分析していきます。<br>投資について深く知り、広い視野をもって世界経済の姿を学んでいきましょう。
                </p>
            </div>
